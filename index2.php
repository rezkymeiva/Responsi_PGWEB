...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><i class="fa-solid fa-map-location-dot"></i> PERSEBARAN RUMAH SAKIT KOTA BANDUNG</a>
...
<script src="plugin/leaflet-search-master/leaflet-search-master/dist/leaflet-search.min.js">
</script>
...
<script>
    ...
    $.getJSON("data/rumahsakit_bandung.geojson", function(data) {
